		    ...
		    <div class="form-group">
		      	...
		      	<div class="col-sm-6">
			      	<select class="form-control" name="verify_id" style="width: 100%">
			      		...
			      		<optgroup label="Nhóm Kế toán">
			      		<?php foreach ($this->_list_accountant as $key => $value) { ?>
			      		<option value="<?php echo $value->id;?>"><?php echo $value->last_name.' '.$value->first_name;?></option>
			      		<?php } ?>
			      		</optgroup>
		  	...
		  	<tbody>
		  		...
		  		<tr>
		  			...
		  			<td class="text-center">
		  				<a target="_blank" class="btn btn-xs btn-primary" href="depots/depot_print/<?php echo $value->id;?>"><i class="fa fa-print"></i></a>
		  				<a target="_blank" class="btn btn-xs btn-danger" href="depots/remove/<?php echo $value->id;?>"><i class="fa fa-trash"></i></a>
		  			</td>
		  		</tr>
		  		<?php } ?>
		  	</tbody>
